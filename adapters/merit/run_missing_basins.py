...
# Codes 87 and 88 (Antarctic sub-basins) are absent from the mghydro.com raster
# distribution — HTTP 404 for both flowdir87.tif/flowdir88.tif and their accum
# equivalents.  Codes 18 and 29 are present in the Lin et al. 2019 pfaf_level_02
# shapefile set and at mghydro.com, so they are included here.
