...
On the preserved corpus, the read-only `orient` preflight resolved every reach of `2020003440`, `2020065840`, `2020071190`, `4020050470`, `6020000010`, and control `7020000010`; `1020018110` and `5020049720` refuse at duplicate unit identity before orientation. For the control, the outlets of 5,425 units differ from the planetary revision `43a98aff` output by at most `0.00106` degrees: 5,340 exact-coincidence-proven reaches, one successor-side-proven reach, and 84 roots now proven from exact predecessor evidence, all of which that revision had resolved by trusting the final source vertex. Same-level graph edges are identical.
