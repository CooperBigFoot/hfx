...
> **Historical.** Superseded by [`hfx.aux.d8_raster.v2`](./v2.md) as of HFX v0.3.0,
> which makes raster CRS, flow-direction encoding, and flow-accumulation units
> declarative and reads dtype and nodata from each GeoTIFF header. This document
> is retained for datasets that still declare `hfx.aux.d8_raster.v1`.
