...
<!-- BEGIN COMPILE CAMPAIGN CONTRACT
{
  ...
  "lifecycle_ledger": {
    ...
    "rehearsal_authority": {"maintainer": "Nicolas Lazaro", "date": "2026-09-04", "lifecycles": 1, "record": "RECORD-URL", "campaign": "campaign-rehearsal", "contract": "scripts/hetzner/rehearsal-campaign-contract.json", "limits": "one cx23 in fsn1, one 10 GB volume, under 6 hours from the provisioning request, under EUR 1.00 projected and actual, exact-resource teardown"},
    "current_authority": {"maintainer": "Nicolas Lazaro", "date": "2026-09-04", "lifecycles": 1, "record": "RECORD-URL", "precondition": "a lifecycle-result.json with result passed under the rehearsal evidence root for campaign-rehearsal", "limits": "one ccx33 in fsn1, one 600 GB volume, under 72 hours from the provisioning request, under EUR 40.00 projected and actual, exact-resource teardown"}
  },
