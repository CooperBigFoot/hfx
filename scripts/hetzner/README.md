...
Draft evidence: [62-basin TDX-Hydro extension workload and final driver failure](CAMPAIGN-tdx-hydro-extension.md), with small-manifest verification and executable consumed-authority refusal still required.
